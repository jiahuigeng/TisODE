...
def get_mnist_loaders(isTrain=False, batch_size=128, test_batch_size=1000):
    if isTrain:
        ...
        test_loader_n = DataLoader(
            ...
            batch_size=test_batch_size, shuffle=False, num_workers=2, drop_last=True)  # 2
...
if __name__ == '__main__':
    ...
    fgsm5 = 0 if True else adversarial_attack(1000,model,test_loader,0.5,0.5,1)
    pgd2 = 0 if False else adversarial_attack(1000,model,test_loader,0.2,0.04,10)
    pgd3 = 0 if False else adversarial_attack(1000,model,test_loader,0.3,0.06,10)
    black = 0 if False else adversarial_attack(1000,model,test_loader,0.4,0.05,35,isblackbox=True)
    logger.info(
